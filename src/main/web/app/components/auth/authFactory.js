...
.factory('AuthFactory', ['$http', '$q', '$rootScope', '$window', 'oAuth', 'DIPNET_REST_ROOT', 'APP_ROOT',
    function ($http, $q, $rootScope, $window, oAuth, DIPNET_REST_ROOT, APP_ROOT) {
        ...
        function login(username, password) {
            var config = {
                method: 'POST',
                url: DIPNET_REST_ROOT + 'authenticationService/oauth/accessToken',
                data: {
                    client_id: client_id,
        ...
        function refreshAccessToken() {
            ...
            if (checkAuthenticated() && !triedToRefresh && !angular.isUndefined(refreshToken)) {
                var config = {
                    method: 'POST',
                    url: DIPNET_REST_ROOT + 'authenticationService/oauth/refresh',
                    data: {
                        client_id: client_id,
