angular.module('fims.users')
    ...
    .controller('ResetPassCtrl', ['$location', '$sce', 'AuthFactory', 'APP_ROOT',
        function ($location, $sce, AuthFactory, APP_ROOT) {
            var vm = this;
            ...
            function resetPassword() {
                ...
                AuthFactory.resetPassword(vm.password, vm.resetToken)
                    .then(
                        function (response) {
                            vm.success = $sce.trustAsHtml("Successfully reset your password. Click <a href='" + APP_ROOT + "/login' class='alert-link'>here</a> to login.");
                        },
                        function (response) {
