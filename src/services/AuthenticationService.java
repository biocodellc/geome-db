...
public class AuthenticationService {
    ...
    public void login(@Context HttpServletResponse response,
        ...
        String redirect_uri = sm.retrieveValue("redirectUri");
...
//        System.out.println("Post params" + postParams);
        ...
        JSONObject tokenJSON = (JSONObject) JSONValue.parse(FimsConnector.createPOSTConnnection(url, postParams));
...
//            System.out.println("Authentication Error, here is the returned token string = " + tokenJSON.toString());
        ...
        JSONObject profileJSON = (JSONObject) JSONValue.parse(FimsConnector.createGETConnection(new URL(profileURL + access_token)));
